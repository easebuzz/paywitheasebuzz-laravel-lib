<?php
    ...
    */
    function _emptyValidation($params, $salt){
        ...
        if(empty($params['merchant_refund_id'])) 
            $empty_value = 'Merchant Refund Id';
    ...
    */
    function _typeValidation($params, $salt, $env){
        ...
        if(!is_string($params['merchant_refund_id']))
            $type_value = "Merchant Refund Id should be string";
    ...
    */
    function _refundPayment($params_array, $salt_key, $url){
        ...
        $curl_result = _curlCall( $url.'transaction/v2/refund', http_build_query($params_array) );
